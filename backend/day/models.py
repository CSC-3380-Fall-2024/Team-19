...
class DayActivity(models.Model):
    itinerary: Itinerary = models.ForeignKey(Itinerary, related_name="activities", on_delete=models.CASCADE, null=True)
    ...
    def __str__(self):
        return f"{self.itinerary.title} - {self.date} - {self.activity}"